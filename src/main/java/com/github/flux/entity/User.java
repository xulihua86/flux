...
public class User {
	...
	public String toString() {
		return "User [userid=" + userid + ", mobile=" + mobile + ", account=" + account + ", addSum=" + addSum
				+ ", subSum=" + subSum + ", logo=" + logo + ", nickname=" + nickname + ", industry=" + industry
				+ ", gender=" + gender + ", year=" + year + ", signature=" + signature + ", createTime=" + createTime
				+ "]";
	}
